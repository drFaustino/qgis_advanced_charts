...
2. Go to **Plugins → Advanced Charts → Open Chart Dialog**.  
...
- X Field: `date`  
- Y Fields: `temperature`, `humidity`, `pressure`  
- Chart type: **Line**  
- Enable: Grid, Legend  
- Titles:  
...
- Y2 Field: `gdp`  
- Chart type: **Line**  
- Customize colors: Y = blue, Y2 = red  
...
- Y Fields: `elev_region_a`, `elev_region_b`, `elev_region_c`  
- Chart type: **Boxplot**  
...
- Y Fields: `indicator_a`, `indicator_b`, `indicator_c`, `indicator_d`  
- Chart type: **Radar**  
